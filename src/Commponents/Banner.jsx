...
const Banner = () => {
  return (
    <section className='bg-gradient-to-r to-green-400 via-blue-300 to-purple-400 relative overflow-hidden '>
...
<div className="absolute inset-0 pointer-events-none hidden md:block">
  ...
  <div className="absolute -bottom-11.25 left-0 w-40 h-40 bg-white rounded-2xl rotate-40 tracking-wide animate-bounce [animation-duration:5.2s]"></div>
      ...
      <Container>
        <div className="max-w-7xl mx-auto px-6 pt-30 pb-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl font-lato md:text-5xl font-bold text-gray-800 ">
              Mehedi
            </h1>
          ...
          <div className="relative hidden md:flex justify-center">
            ...
            <div className="absolute w-84 h-84 bg-indigo-600/20 rounded-full "> </div>
            <img className='rounded-full pt-[-20px] absolute -top-18.5 left-32 w-84 ' src={mehedi} alt="" />
          </div>
        </div>
        <div className="pb-5">
          <div className="w-8 h-12 mx-auto flex items-center justify-center rounded-full border-2 border-white"> 
