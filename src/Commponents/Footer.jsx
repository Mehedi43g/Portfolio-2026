...
const Footer = () => {
  ...
  return (
    <footer
      id="footer"
      className="py-10 bg-linear-to-br from-slate-800 via-slate-900 to-slate-700 text-white overflow-hidden"
    >
      <Container>
        <div
          ref={ref}
          className={`flex flex-col lg:flex-row gap-10 lg:gap-0 justify-between transition-all ${
            visible
        ...
        >
          ...
          <div className="w-full lg:w-4/12">
            ...
            <p className="text-[14px] text-gray-500 pt-6 max-w-sm">
          ...
          <div className="w-full lg:w-2/12">
            ...
            <ul className="flex flex-col gap-3 pt-5 text-[14px]">
              <li className="hover:text-[#00D3F3] duration-300">
                <a href="/">Home</a>
              </li>
              <li className="hover:text-[#00D3F3] duration-300">
          ...
          <div className="w-full lg:w-4/12">
            ...
            <p className="text-[14px] text-gray-500 flex gap-2 pt-4 items-center break-all">
              <GithubIcon /> mdmehedi992124@gmail.com
            </p>
